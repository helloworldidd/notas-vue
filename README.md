...
1. [ejemplo-ejercicio-m8-l1.md](./src/ejemplo-ejercicio-m8-l1.md)
1. [ejemplo-ejercicio-m8-l2.md](./src/ejemplo-ejercicio-m8-l2.md)
1. [ejemplo-ejercicio-m8-l3.md](./src/ejemplo-ejercicio-m8-l3.md)
1. [ejemplo-portafolio-m8.md](./src/ejemplo-portafolio-m8.md)
...
1. [m6-l1-componentes.md](./src/m6-l1-componentes.md)
1. [m6-l2-templates-binding.md](./src/m6-l2-templates-binding.md)
1. [m6-l3-formularios.md](./src/m6-l3-formularios.md)
1. [m6-l4-eventos.md](./src/m6-l4-eventos.md)
1. [m6-l5-rutas.md](./src/m6-l5-rutas.md)

**Lecciones Módulo 7**

1. [m7-l1-componentes.md](./src/m7-l1-componentes.md)
1. [m7-l2-api.md](./src/m7-l2-api.md)
1. [m7-l3-datos-globales.md](./src/m7-l3-datos-globales.md)
1. [m7-l4-pruebas.md](./src/m7-l4-pruebas.md)
...
1. [otros-base-arquitecturas.md](./src/otros-base-arquitecturas.md)
1. [otros-base-compositionAPI.md](./src/otros-base-compositionAPI.md)
1. [otros-base-convencion-nombres.md](./src/otros-base-convencion-nombres.md)
1. [otros-base-images.md](./src/otros-base-images.md)
1. [otros-base-metodologias.md](./src/otros-base-metodologias.md)

<br>

1. [otros-config-prettier-eslint.md](./src/otros-config-prettier-eslint.md)
1. [otros-config-snippets.md](./src/otros-config-snippets.md)

<br>

1. [otros-css-animate.md](./src/otros-css-animate.md)
1. [otros-css-bootstrap.md](./src/otros-css-bootstrap.md)
1. [otros-css-sass.md](./src/otros-css-sass.md)
1. [otros-css-tailwind.md](./src/otros-css-tailwind.md)
1. [otros-css-vuetify.md](./src/otros-css-vuetify.md)
...
1. Bootcamp React (Aporte Ariel)
   - https://chile.generation.org/learners/

1. Curso react de HolaMundo
   - https://www.youtube.com/watch?v=yIr_1CasXkM

1. Documentación oficial
   - https://es.react.dev/

1. Full Stack Open de la Universidad de Helsinki
